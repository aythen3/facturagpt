...
import styles from "./ModalAddConnectionTelematel.module.css";

const ModalAddConnectionTelematel = ({ close, addConnection }) => {
...
export default ModalAddConnectionTelematel;
